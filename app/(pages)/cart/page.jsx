...
import AddressFormPage from "../addresses/form";
...
const Cart = () => {
    ...
    const getSelectedAddress = () => {
        return (
            savedAddresses.find((addr) => addr.isSelected) || savedAddresses[0]
        );
    };
                                ...
                                <div className="shipping-section">
                                    ...
                                    {savedAddresses.length === 0 ? (
                                        <div className="no-address-message">
                                            ...
                                            <p className="address-subtext">
                                                Add an address so we can show
                                                you exact costs and delivery
                                            </p>
                                            <button
                                                onClick={() =>
                                    ...
                                    <div className="warning-message">
                                        ...
                                        <span className="warning-subtext">
                                            Make sure check is perfect before
                                    ...
                                    <div className="shipping-mode-section">
                                        ...
                                        >
                                            ...
                                            <div className="option-details">
                                                ...
                                                <div className="option-description">
                                                    The order is shipped to your
                                                    doorstep depends on your
                                                    pickup range/delivery
                                                    options.
                                                </div>
                                            </div>
                                        </div>

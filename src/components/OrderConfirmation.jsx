...
const OrderConfirmation = ({ customerName, onViewOrder }) => {
    return (
            ...
            <div className="confirmation-card">
                ...
                <div className="confirmation-header">
                    ...
                    <p className="confirmation-message">
                        ...
                        it ready for dispatch and will notify <br></br>
                        you once it's on the way.
                    </p>
                    <p className="forward-message">
                        Sending this to someone else? Forward the 4-digit code
                        below <br></br>so they can receive the package on your
                        behalf.
                    </p>
                </div>

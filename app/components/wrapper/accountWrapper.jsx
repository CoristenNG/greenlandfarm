            ...
            <div className="min-h-screen max-w-6xl mx-auto">
                ...
                <div className="">
                    <div className="flex flex-col md:flex-row ">
                        ...
                        <aside
                            className={`
                            fixed inset-y-0 left-0 w-64 z-40 md:z-0 top-38 shrink-0 md:top-0 bg-white shadow-sm md:shadow-none  transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:rounded-lg
                            ${
                                isSidebarOpen
                                    ? "translate-x-0"
                                    : "-translate-x-full"

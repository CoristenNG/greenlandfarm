      ...
      <div className="home-container">
        ...
        <div className="stats-division">
          <div className="section-header">
            ...
            <p className="section-text">
              We may be starting out, but our roots are deep — and so is our growth!
            </p>
          </div>
        ...
        <section className="bulk-section">
          <div className="bulk-container">
            ...
            <div className="bulk-text">
              <span className="bulk-head">Buy in Bulk – For Businesses & Big Needs</span>
              <h2 className="bulk-title">Supplying restaurants, retailers, and food vendors.</h2>
              <p className="bulk-description">
                Supplying restaurants, retailers, and food vendors. We've got you covered.
                Our bulk service is built for speed, hygiene, and reliability. Whether you
                run a kitchen, a supermarket, or an event business, you can count on us for
                sorted, form-fresh produce that's ready to go.
              </p>
              ...
              {testimonials.map((testimonial) => (
                <SwiperSlide key={testimonial.id}>
                  <div className="testimonial-card">
                    ...
                    <div className="stars">
                      {[...Array(5)].map((_, i) => (
                        <span key={i} className={i < testimonial.rating ? "star" : "star-outline"}>

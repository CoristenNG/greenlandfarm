        ...
        <div className="product-container">
          ...
          <div className="product-info">
            ...
            <div className="product-price">
              {product.price} <span className="product-price-span">/kg</span>
            </div>

            <p className="short-description">
              Our Bell Peppers are handpicked fresh from our pesticide-free
              fields. They're sweet, crunchy, and perfect for stews, salads, and
              jollof rice.
            </p>
                  ...
                  <div className="great-for">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        Snacking: Enjoy raw with hummus or your preferred dip
                        for a healthy and satisfying snack.
                      </li>
                      <li>
                        <span>Freezing for Future Use:</span> Ideal for dicing
                        and freezing, allowing you to enjoy farm-fresh flavor
                    ...
                    <div className="reviews-list">
                      ...
                      <div className="review-item">
                        ...
                        <p className="review-text">
                          ...
                          fajitas and other vegetable items. You can really
                          taste the difference from farm-fresh produce. Delivery
                          to Lagos is always on time too!
                        </p>
                      ...
                      <div className="review-item">
                        ...
                        <p className="review-text">
                          These bell peppers are always vibrant green and firm.
                          I use them constantly in my stir-fries and even for a
                      ...
                      <div className="review-item">
                        ...
                        <p className="review-text">
                          ...
                          the fridge too. Fantastic for salads and for adding
                          that authentic flavour to my jollof rice. Will

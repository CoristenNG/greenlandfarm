...
const CheckoutPage = ({ cartItems, total, shippingAddress, onBackToCart }) => {
            ...
            <div className="delivery-details-section">
              ...
              <div className="delivery-option">
                <div>
                  ...
                  <p>
                    The order is delivered to your location across Nigeria but
                    prices may differ due to location.
                  </p>
                </div>
                <div>
                  <button className="change-button">Change</button>
          ...
          <div className="checkout-section">
            ...
            <div className="bulk-order-inform">
              ...
              <p className="info-text">
                ...
                <span className="highlight-text"> contact us</span> directly or
                call
                <span className="highlight-text"> +234 (913) 443 4790</span> for
                customized pricing and delivery arrangements.
              </p>
            </div>

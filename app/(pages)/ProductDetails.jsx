...
const ProductDetails = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            reviews: 90,
            description:
                "Premium quality red beans, rich in protein and fiber.",
            specifications: [
                    ...
                    <div className="product-container">
                        ...
                        <div className="product-info">
                            ...
                            <p className="short-description">
                                ...
                                pesticide-free fields. They're sweet, crunchy,
                                and perfect for stews, salads, and jollof rice.
                            </p>
                                    ...
                                    <div className="description-text">
                                        ...
                                        <div className="great-for">
                                            ...
                                            <ul>
                                                <li>
                                                    <span>Cooking:</span>{" "}
                                                    Perfect for adding a crisp
                                                    texture and subtly sweet
                                                    flavor to soups, sauces,
                                                    stir-fries, fajitas, and
                                                    roasts.
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    Ideal for dicing and
                                                    freezing, allowing you to
                                            ...
                                            <div className="reviews-list">
                                                ...
                                                <div className="review-item">
                                                    ...
                                                    <p className="review-text">
                                                        ...
                                                        So fresh and crisp,
                                                        perfect for my fajitas
                                                        and other vegetable
                                                        items. You can really
                                                        taste the difference
                                                        from farm-fresh produce.
                                                        Delivery to Lagos is
                                                        always on time too!
                                                    </p>
                                                ...
                                                <div className="review-item">
                                                    ...
                                                    <p className="review-text">
                                                        ...
                                                        fresh these green
                                                        peppers arrive. It's
                                                        like I just picked them
                                                        myself. They last well
                                                        in the fridge too.
                                                        Fantastic for salads and
                                                        for adding that

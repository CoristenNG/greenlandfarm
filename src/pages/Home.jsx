...
import Bulk from "../assets/bulkImg.png";
import {
  ShoppingBasket,
  Utensils,
  Truck,
    ...
    <div className="home-container">
      ...
      <div className="stats-division">
        <div className="section-header">
          ...
          <p className="section-text">
            We may be starting out, but our roots are deep — and so is our
            growth!
          </p>
        </div>
          ...
          <div className="content-wrapper">
            <div className="text-content">
              ...
              <p className="section-description">
                There's farm produce - and then there's produce that's been
                grown, raised, and handled with precision and care. Whether it's
                greenhouse or quality, or fresh eggs, we bring the same standard
                of excellence to anything we offer. Here's why our customers
                stick with us:
              </p>
        ...
        <div className="bulk-container">
          ...
          <div className="bulk-text">
            ...
            <h2 className="bulk-title">
              Supplying restaurants, retailers, and food vendors.
            </h2>
            <p className="bulk-description">
              Supplying restaurants, retailers, and food vendors. We've got you
              covered. Our bulk service is built for speed, hygiene, and
              reliability. Whether you run a kitchen, a supermarket, or an event
              business, you can count on us for sorted, form-fresh produce
              that's ready to go.
            </p>

            <h3 className="bulk-subtitle">Why choose our bulk service?</h3>
            ...
            <div className="bulk-features">
              ...
              <div className="bulk-feature-item">
                ...
                <div className="bulk-feature-content">
                  <p>Clean, sorted, ready-to-use produce</p>
                </div>
              </div>
              <div className="bulk-feature-item">
                <div className="bulk-feature-icon">
              ...
              <div className="bulk-feature-item">
                ...
                <div className="bulk-feature-content">
                  <p>Dedicated support for large orders</p>
                </div>
              </div>
            </div>
                  ...
                  <div className="stars">
                    {[...Array(5)].map((_, i) => (
                      <span
                        key={i}
                        className={
                          i < testimonial.rating ? "star" : "star-outline"
                        }
                      >

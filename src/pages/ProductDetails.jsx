...
const ProductDetails = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      reviews: 120,
      description:
        "Our red peppers are carefully cultivated for maximum flavor and nutrition.",
      specifications: [
        { attribute: "Category", value: "Fresh Vegetables" },
        { attribute: "Weight/Unit", value: "Sold per kg" },
      ],
    ...
    },
    {
      ...
      reviews: 140,
      description:
        "Juicy, ripe tomatoes perfect for sauces, salads and cooking.",
      specifications: [
        { attribute: "Category", value: "Fresh Vegetables" },
        { attribute: "Weight/Unit", value: "Sold per kg" },
      ],
                  ...
                  <div className="product-container">
                      ...
                      <div className="product-info">
                          ...
                          <div className="product-price">
                              {product.price}{" "}
                              <span className="product-price-span">/kg</span>
                          </div>

                          <p className="short-description">
                              Our Bell Peppers are handpicked fresh from our
                              pesticide-free fields. They're sweet, crunchy, and
                              perfect for stews, salads, and jollof rice.
                          </p>
                              ...
                              <div className="description-content">
                                  <div className="description-text">
                                      ...
                                      <div className="great-for">
                                          ...
                                          <ul>
                                              <li>
                                                  <span>Cooking:</span> Perfect
                                                  for adding a crisp texture and
                                                  subtly sweet flavor to soups,
                                                  sauces, stir-fries, fajitas,
                                                  and roasts.
                                              </li>
                                              <li>
                                                  <span>Salads:</span> Slice
                                                  them thin for a refreshing
                                                  crunch and vibrant color in
                                                  your favorite fresh salads.
                                                  Snacking: Enjoy raw with
                                                  hummus or your preferred dip
                                                  for a healthy and satisfying
                                                  snack.
                                              </li>
                                              <li>
                                                  <span>
                                          ...
                                          <div className="reviews-list">
                                              ...
                                              <div className="review-item">
                                                  ...
                                                  <p className="review-text">
                                                      I always order my green
                                                      peppers from here, and
                                                      they never disappoint. So
                                                      fresh and crisp, perfect
                                                      for my fajitas and other
                                                      vegetable items. You can
                                                      really taste the
                                                      difference from farm-fresh
                                                      produce. Delivery to Lagos
                                                      is always on time too!
                                                  </p>
                                              ...
                                              <div className="review-item">
                                                  ...
                                                  <p className="review-text">
                                                      ...
                                                      always vibrant green and
                                                      firm. I use them
                                                      constantly in my
                                                      stir-fries and even for a
                                                      quick, healthy snack.
                                                      Knowing they're from an
                                                      Eco greenhouse without
                                                      chemicals makes me feel
                                                      good about what I'm
                                                      eating. Highly recommend!
                                                  </p>
                                                  <div className="review-actions">
                                                      <span className="helpful-text">
                                                          Was this helpful?
                                              ...
                                              <div className="review-item">
                                                  ...
                                                  <p className="review-text">
                                                      I'm impressed by how fresh
                                                      these green peppers
                                                      arrive. It's like I just
                                                      picked them myself. They
                                                      last well in the fridge
                                                      too. Fantastic for salads
                                                      and for adding that
                                                      authentic flavour to my
                                                      jollof rice. Will

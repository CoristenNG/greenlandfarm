...
import OTPVerification from "../auth/otp/otpPage";
...
const SettingsPage = () => {
    ...
    const [changeEmail, { isLoading: verifying }] = useChangeEmailMutation();
    const [updateImage, { isLoading: uploadingPicture }] =
    ...
    const { data, isLoading } = useSWR("/user/get-account");
